...
export default async function handler(req, res) {
  ...
  if (!auth.valid) {
    console.warn('[Email] Unauthorized rejection email attempt from:', req.headers.origin)
  ...
  try {
    await transporter.sendMail({
      ...
      to,
      subject: 'Update on your Yobbu listing',
      html: `
        <div style="font-family:'DM Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#FDFBF7;border-radius:16px;overflow:hidden;">
          ...
          <div style="padding:36px 32px;">
            <h1 style="font-size:24px;color:#1A1710;margin:0 0 8px;text-align:center;">Your listing has been suspended</h1>
            <p style="font-size:15px;color:#8A8070;text-align:center;line-height:1.6;margin:0 0 28px;">
              Hi <strong style="color:#1A1710">${safeName}</strong>, your listing has been temporarily suspended by the Yobbu team pending review.
            </p>
            ...
            <div style="background:#FEF2F2;border:1px solid #FECACA;border-radius:10px;padding:14px 16px;margin-bottom:24px;font-size:13px;color:#DC2626;">
              If you believe this is a mistake, please reply to this email and our team will review your case.
            </div>
            <a href="mailto:hello@yobbu.co" style="display:block;text-align:center;background:#1A1710;color:#fff;text-decoration:none;padding:14px;border-radius:12px;font-weight:600;font-size:15px;">Contact us</a>
          </div>
    ...
    console.error('[Email] Rejection send error:', err.message)
