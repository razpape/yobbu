        ...
        <div style="font-family:'DM Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#FDFBF7;border-radius:16px;overflow:hidden;">
          ...
          <div style="padding:36px 32px;">
            ...
            <p style="font-size:15px;color:#8A8070;text-align:center;line-height:1.6;margin:0 0 28px;">
              Hi <strong style="color:#1A1710">${name}</strong>, your listing has been temporarily suspended by the Yobbu team pending review.
            </p>
            ...
            <a href="mailto:hello@yobbu.co" style="display:block;text-align:center;background:#1A1710;color:#fff;text-decoration:none;padding:14px;border-radius:12px;font-weight:600;font-size:15px;">
              Contact us →
            </a>
          </div>
