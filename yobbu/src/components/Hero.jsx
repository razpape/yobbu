    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hero-search { order: -1; margin-bottom: 28px !important; }
          .hero-badge  { order: 0;  margin-bottom: 16px !important; }
          .hero-title  { order: 1; }
          .hero-sub    { order: 2; }
          .hero-trust  { order: 3; }
        }
        ...
        <section style={{ overflow: 'hidden', position: 'relative' }}>
          ...
          <div className="hero-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', maxWidth:1280, margin:'0 auto', width:'100%', position:'relative', zIndex:2, padding:'64px 48px 80px' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column' }}>
              ...
              {/* Search bar */}
              <div className="search-bar anim-4 hero-search" style={{ display:'flex', alignItems:'stretch', background:'#fff', borderRadius:16, boxShadow:'0 2px 8px rgba(0,0,0,.04), 0 12px 40px rgba(0,0,0,.06)', overflow:'hidden', marginBottom:20, border:'1px solid rgba(0,0,0,.04)' }}>
