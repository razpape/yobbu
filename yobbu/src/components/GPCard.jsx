        ...
        <div className="gp-inner" style={{ flex:1, display:'flex', alignItems:'center', padding:'16px 22px', gap:0 }}>
          ...
          <div className="gp-name-sec" style={{ display:'flex', alignItems:'center', gap:12, width:170, flexShrink:0 }}>
            <div style={{ position:'relative', flexShrink:0 }}>
              ...
              {gp.id_verified && (
                <div style={{ position:'absolute', bottom:-2, right:-2, width:16, height:16, borderRadius:'50%', background:'#fff', border:'1.5px solid #F0C878', display:'flex', alignItems:'center', justifyContent:'center', fontSize:8 }}>🛡</div>
              )}
            </div>
            <div>
