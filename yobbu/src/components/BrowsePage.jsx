        ...
        <div style={{ padding:'4px 12px 8px' }}>
          {FLIGHTS.map((f, i) => (
            <div key={i} style={{ display:'flex', alignItems:'center', gap:10, padding:'9px 0', borderBottom: i < FLIGHTS.length-1 ? '1px solid rgba(0,0,0,.04)' : 'none' }}>
              <div style={{ width:28, height:28, borderRadius:8, background:'#F7F3ED', display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, flexShrink:0 }}>✈</div>
              <div style={{ flex:1 }}>
          ...
          <div>
            ...
            <div style={{ display:'flex', gap:10, marginBottom:24, flexWrap:'wrap' }}>
              <div style={{ flex:1, minWidth:200, position:'relative' }}>
                <span style={{ position:'absolute', left:12, top:'50%', transform:'translateY(-50%)', fontSize:14, color:'#B0A090' }}>🔍</span>
                <input
