export const translations = {
  en: {
    ...
    heroSub:      'Find verified GPs going to Dakar, Conakry, and beyond. Your package travels with a real person from your community — not a faceless courier.',
    heroCta1:     'Find a GP',
    heroCta2:     "I'm a GP",
    ...
    // Trust
    trustStrip:   'Every GP is phone-verified. ID-verified GPs carry a shield badge. Your package is protected.',
    browseTrust:  'Every GP is phone-verified. ID-verified GPs carry a shield badge.',
    ...
    hiw2Text:  'Reach the GP directly on WhatsApp. Agree on price, pickup, and package details.',
    ...
    // Browse
    countLabel:   (n) => `${n} GP${n !== 1 ? 's' : ''} available`,
    noResults:    'No GPs found for this route.',
  ...
  fr: {
    ...
    heroSub:      'Trouvez des GPs vérifiés qui vont à Dakar, Conakry et ailleurs. Votre colis voyage avec une vraie personne de votre communauté.',
    heroCta1:     'Trouver un GP',
    heroCta2:     'Je suis un GP',
    ...
    trustStrip:  "Chaque GP est vérifié par téléphone. Les GPs vérifiés par pièce d'identité portent un badge.",
    browseTrust: "Chaque GP est vérifié par téléphone. Les GPs vérifiés portent un badge bouclier.",

    hiwTitle: 'Comment fonctionne Yobbu',
    hiwSub:   'Trois étapes simples pour envoyer votre colis',
    hiw1Title: 'Trouver un GP',
    ...
    hiw2Text:  'Contactez le GP directement sur WhatsApp. Convenez du prix et des détails du colis.',
    hiw3Title: 'Colis livré',
    hiw3Text:  'Votre famille reçoit le colis. Laissez un avis pour aider la prochaine personne.',

    countLabel:     (n) => `${n} GP${n !== 1 ? 's' : ''} disponible${n !== 1 ? 's' : ''}`,
    noResults:      'Aucun GP trouvé pour cette route.',
