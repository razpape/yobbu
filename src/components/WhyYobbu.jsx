      ...
      <section className="why-section" style={{ padding: '80px 48px', background: '#FDFBF7', borderBottom: '1px solid rgba(0,0,0,.06)', fontFamily: 'DM Sans, sans-serif' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 40 }}>
            <div style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1.5px', color: '#10B981', marginBottom: 12, background: '#D1F4E7', border: '1px solid #D4A574', borderRadius: 20, display: 'inline-block', padding: '4px 14px' }}>
            ...
            <h2 style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(28px, 3vw, 42px)', color: '#1F2937', lineHeight: 1.12, letterSpacing: '-.5px', marginTop: 12 }}>
              {isFr
                ? <>Pourquoi <em style={{ fontStyle: 'italic', color: '#10B981' }}>Yobbu</em> est le bon choix</>
                : <>Why <em style={{ fontStyle: 'italic', color: '#10B981' }}>Yobbu</em> is the right choice</>}
            </h2>
          </div>
          ...
          <div className="why-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, alignItems: 'stretch' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              {[
                {
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
                ...
                {
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>,
                ...
                {
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
                ...
                {
                  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
                ...
                <div key={title} style={{ background: '#fff', borderRadius: 16, padding: '24px 20px', border: '1px solid rgba(0,0,0,.06)', boxShadow: '0 1px 6px rgba(0,0,0,.04)' }}>
                  <div style={{ width: 44, height: 44, borderRadius: 12, background: '#D1F4E7', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                    {icon}
                  </div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: '#1F2937', marginBottom: 8, lineHeight: 1.3 }}>{title}</div>
            ...
            {/* Right — big dark card */}
            <div className="why-right" style={{ background: '#1F2937', borderRadius: 20, padding: '36px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: 360 }}>
              <div>
              ...
              <button
                style={{ marginTop: 32, background: '#10B981', color: '#fff', border: 'none', borderRadius: 12, padding: '13px 24px', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'DM Sans, sans-serif', display: 'flex', alignItems: 'center', gap: 8, width: 'fit-content', transition: 'background .2s' }}
