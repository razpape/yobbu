...
// ---------------------------------------------------------------------------
// CircleCropper — modal that lets the user drag/zoom to frame within a circle
// ---------------------------------------------------------------------------
function CircleCropper({ src, onConfirm, onCancel }) {
