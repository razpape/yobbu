...
export default function SocialProfileLinks({ profile, lang = 'en', onSave }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setEditing(false)
      onSave?.({ facebook_url: facebookUrl, linkedin_url: linkedinUrl })
  ...
  const hasLinks = profile?.facebook_url || profile?.linkedin_url
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {profile?.facebook_url && (
            ...
            >
              ...
              <span style={{ fontSize: 11, color: '#1877F2' }}>{t.view} →</span>
            </a>
          )}
          ...
          {profile?.linkedin_url && (
            ...
            >
              ...
              <span style={{ fontSize: 11, color: '#0A66C2' }}>{t.view} →</span>
            </a>
          )}
        </div>
      )}
